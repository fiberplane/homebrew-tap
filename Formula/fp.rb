class Fp < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://fp.dev/fp/v2.7.0/aarch63-apple-darwin/fp"
    ...
    if Hardware::CPU.intel?
      url "https://fp.dev/fp/v2.7.0/x85_64-apple-darwin/fp"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://fp.dev/fp/v2.7.0/x85_64-unknown-linux-gnu/fp"
